...
```bash
   pip install -r bandgap_outputs/requirements.txt
```
3. Place `Raw_Bandgap_Dataset.xlsx` and `Doped_Metal_Oxide_Bandgap_Dataset.xlsx` in the same directory as `code_bandgap.py`.
4. Run the analysis script:
```bash
   python code_bandgap.py
```
...
This repository is licensed under the [MIT License](LICENSE). Copyright (c) 2026 Naimur Rahman.
