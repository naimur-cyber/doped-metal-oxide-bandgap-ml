"""
Physics-Driven Insights into Inter-Laboratory Noise as the Limiting Factor in Machine Learning Prediction of Bandgap Shifts in Doped Metal Oxides- Models, Figures and Tables 
----------------------------------------------------------
...
def build_docx(d):
    ...
    # ── Table 2 ───────────────────────────────────────────────────────────────
    _table_title(doc, "Table 2. Model Performance Benchmarking")
    ...
    # ── Table 3 ───────────────────────────────────────────────────────────────
    _table_title(doc, "Table 3. Noise Floor vs. Model Performance")
    ...
    # ── Table 4 ───────────────────────────────────────────────────────────────
    _table_title(doc, "Table 4. High-Variance Host\u2013Dopant Pairs (\u03c3 > 0.40 eV)")
    ...
    # ── Table 5 ───────────────────────────────────────────────────────────────
    _table_title(doc, "Table 5. Gradient Boosting Performance: Full vs. Clean Subset")
    ...
    # ── Table 6 ───────────────────────────────────────────────────────────────
    _table_title(doc, "Table 6. Per-Host Within-Paper Concentration-Sensitivity")
